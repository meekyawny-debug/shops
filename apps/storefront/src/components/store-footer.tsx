      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <h3 className="font-heading text-xl font-bold tracking-widest uppercase mb-4">
              {store.name}
            </h3>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            {/* Visa */}
            <svg className="h-8 w-auto text-muted-foreground/50" viewBox="0 0 48 32" fill="none">
              <rect width="48" height="32" rx="4" fill="currentColor" opacity="0.1" />
              <text x="24" y="20" textAnchor="middle" fontSize="10" fontWeight="bold" fill="currentColor">VISA</text>
            </svg>
            {/* Mastercard */}
            <svg className="h-8 w-auto text-muted-foreground/50" viewBox="0 0 48 32" fill="none">
              <rect width="48" height="32" rx="4" fill="currentColor" opacity="0.1" />
              <text x="24" y="20" textAnchor="middle" fontSize="8" fontWeight="bold" fill="currentColor">MC</text>
            </svg>
            {/* Amex */}
            <svg className="h-8 w-auto text-muted-foreground/50" viewBox="0 0 48 32" fill="none">
              <rect width="48" height="32" rx="4" fill="currentColor" opacity="0.1" />
              <text x="24" y="20" textAnchor="middle" fontSize="8" fontWeight="bold" fill="currentColor">AMEX</text>
            </svg>
            {/* PayPal */}
            <svg className="h-8 w-auto text-muted-foreground/50" viewBox="0 0 48 32" fill="none">
              <rect width="48" height="32" rx="4" fill="currentColor" opacity="0.1" />
              <text x="24" y="20" textAnchor="middle" fontSize="7" fontWeight="bold" fill="currentColor">PayPal</text>
            </svg>
          </div>
